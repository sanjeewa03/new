...
const IMAGES=[
    ...
    {"id":2,"category":"galle","header":"Backpacking Trip Planner > Sri Lanka > Waterfalls ", "title":"Waterfalls in Sri Lanka","caption":"View from a boat","url":"assets/img/2.jpg"},
    {"id":3,"category":"galle","header":"Backpacking Trip Planner > Sri Lanka > sanctuaries", "title":"Pinnawala and sanctuaries","caption":"View from a boat","url":"assets/img/3.jpg"},
    ...
    {"id":6,"category":"matara","header":"Backpacking Trip Planner > Sri Lanka > Heritages", "title":"Sigiriya and Heritages","caption":"View from a boat","url":"assets/img/6.jpg"},
    ...
    {"id":10,"category":"colombo", "header":"Backpacking Trip Planner > Sri Lanka >  North City","title":"Jaffna North City","caption":"View from a boat","url":"assets/img/10.jpg"}
